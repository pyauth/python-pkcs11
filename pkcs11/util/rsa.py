...
from pkcs11.types import AttributeDict, PublicKey
from pkcs11.util import biginteger


def decode_rsa_private_key(
    der: bytes, capabilities: Optional[MechanismFlag] = None
) -> AttributeDict:
    """
...
def decode_rsa_public_key(
    ...
    key: RSAPublicKey = RSAPublicKey.load(der)
    return {
